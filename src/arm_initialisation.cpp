...
KDL::Chain get_robot_model() 
{
    ...
    if (!urdf_model.initFile("/home/salvin/feedback_pouring/urdf/GEN3-7DOF-VISION_ARM_URDF_V12.urdf"))
    {
...
KDL::ChainExternalWrenchEstimator external_wrench_estimator_test()
{
    /**
    ...
    std::cout << "KDL External Wrench Estimator Test" << std::endl;
    std::cout << "Number of segments: " << ns << std::endl;
    ...
    cout << "Test cases: iteration step" << endl;
    for (unsigned int i = 0; i < jnt_pos.size(); i++)
    {
        ...
        cout << "Joint torque reference: " << ext_torque_reference.data.transpose() << endl;
...
int main(int argc, char **argv)
{
    ...
    KDL::ChainExternalWrenchEstimator wrench1 = external_wrench_estimator_test();
